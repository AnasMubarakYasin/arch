import {TAG, ARG, CHILD, ELEMENT, ENV, KEY, VALUE} from './constant.js';
import { TemplateInit, TemplateTree } from './type.js';

export function transformCore(template: TemplateInit) {
